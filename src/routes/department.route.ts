...
import { createDepartmentSchema, detailDepartmentSchema, updateDepartmentSchema } from '@/constants/schema'
...
router.get('/departments', verifyToken, department.getDepartment)
